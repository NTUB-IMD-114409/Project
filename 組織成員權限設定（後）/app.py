...
# === 2. 語音轉文字 (Whisper 推論) ===
from punctuation_utils import restore_punctuation_remote
...
def whisper_transcribe():
    try:
        ...
        # 呼叫 Hugging Face 空間做標點還原
        polished_text = restore_punctuation_remote(raw_text)
...
def ask_file():
    try:
        ...
        ask_prompt = f"請根據以下摘要以簡明清楚的方式回答我的問題。：\n{summary_for_ask}\n\n問題：{question}"
