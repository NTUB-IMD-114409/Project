...
from .semantic_classifier import classify_all, aggregate
from .llm_utils import get_llm_langchain, _extract_struct_items_with_rag
from .llm_constants import TEMPLATE_SCHEMAS, safe_json_loads, _strip_code_fences, _replace_smart_quotes
...
def generate_docx():
    ...
    try:
        ...
        segments = classify_all(segments, llm)
        ai_ctx = aggregate(segments)  # 產生：chairman_reports, committee_reports, proposals, temporary_motions
